...
window.require.register("scripts/fractal", function(exports, require, module) {
  var getPixel, hslToRgb, hueToRgb, mandlebrot, naiveFractal, setPixel, shaderFractal;
  ...
  shaderFractal = function() {
    var animate, camera, container, curX, curY, fractal, fractalTypes, frag, gui, material, mesh, onWindowResize, render, renderer, scale, scene, typeController, uniforms, vert;
    render = function() {
    ...
    uniforms = {
      ...
      uTex: {
        type: "t",
        value: THREE.ImageUtils.loadTexture("pal.png")
      },
      center: {
        type: "v2",
